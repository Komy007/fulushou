...
import { Clock, Package, Megaphone, Truck } from 'lucide-react';
import { 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-stone-800 rounded-2xl p-6 lg:p-10 border border-stone-700 shadow-2xl">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-2/3 bg-stone-900 rounded-xl p-6 border border-stone-700 relative flex flex-col">
