...
import { TrendingUp, Award, Map, Rocket, ChevronRight, Star, MousePointer2 } from 'lucide-react';
import { 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-stretch">
            ...
            <div className="bg-[#EAE4D9] p-5 rounded-[2.5rem] border border-stone-200 shadow-xl space-y-4">
              {milestones.map((m) => (
                <button 
                  ...
                  className={`w-full group relative flex items-center p-6 rounded-[1.8rem] transition-all duration-500 transform ${
                    activeTab === m.id 
                ...
                >
                  <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mr-5 shrink-0 transition-all duration-500 ${
                    activeTab === m.id ? 'bg-amber-600 text-white rotate-3' : 'bg-stone-100 text-stone-400'
                  }`}>
                    <m.icon size={28} />
                  </div>
          ...
          <div className="lg:flex-1 w-full">
            <div className="bg-[#FAF8F3] rounded-[3.5rem] p-10 lg:p-16 border border-stone-200 shadow-2xl min-h-[850px] flex flex-col relative overflow-hidden">
