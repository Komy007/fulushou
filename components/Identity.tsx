    ...
    <section id="identity" ref={sectionRef} className="py-20 md:py-28 lg:py-36 bg-cream relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`text-center mb-14 md:mb-20 ${fade()}`}>
          ...
          <h2 className="font-cjk font-black text-ink tracking-widest mb-6"
            ...
            >
              ...
              <div className="p-7 md:p-8 relative">
                <div className="flex items-end gap-3 mb-5">
                  <span className={`font-cjk font-black text-7xl md:text-8xl leading-none ${item.color}`}>
                    {item.char}
                  </span>
                  <div className="mb-1">
                ...
                {/* Watermark */}
                <div className={`absolute -bottom-4 -right-4 text-[10rem] font-black leading-none pointer-events-none select-none opacity-[0.04] font-cjk ${item.color}`}>
                  {item.char}
                </div>
              </div>
            </div>
